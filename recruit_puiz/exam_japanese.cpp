...
QuestionList CreateKanjiExam()
{
	static const struct
	{
		...
		{ "知己", "ちき", "自分を用理解してくれる人、親しい友人" },
		{ "境内", "けいだい", "神社、寺院の敷地内" },
		{ "破綻", "はたん", "物事が上手くいかなくなること" },
		{ "拘泥", "こうでい", "1つの考え方や行動にこだわること" },
		{ "吟味", "ぎんみ", "物事を念入りに調べること" },
...
QuestionList CreateHomophoneExam()
{
	const struct
	{
		...
		{ "そうぞう",{
			...
			{"創造", "新しいものを作り上げること"}} },
		{"ほしょう",{
			{"保証", "間違いなく確かであると約束すること"},
			{"保障", "権利や地位などが維持されるように保護し守ること"},
			{"補償", "損失をおぎなって償うこと"}} },
		{ "たいしょう",{
			{"対象", "行為の目標となるもの"},
			{"対称", "2つの図形や物事がお互いにつり合っていること"},
			{"対照", "見比べること、違いが際立つこと"}} },
		{"あやまる",{
			{"謝る", "失敗について許しを求める"},
			{"誤る", "間違った判断をする"}} },
